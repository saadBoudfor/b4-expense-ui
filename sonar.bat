...
sonar-scanner.bat -D"sonar.projectKey=expense_ui" -D"sonar.sources=." -D"sonar.host.url=http://localhost:9000" -D"sonar.login=1f5398f41e86796c3ae23ec4246cacbbdda33d51"
